...
angular.module('user')
.directive('userHistory', ['$interval', 'socketService', 'appService', '$window', 'API', 'Auth',
    function ($interval, socketService, appService, $window, API, Auth) {
        ...
        return {
            restrict: 'E',
            templateUrl: 'app/pages/user/private/historial/historial.template.html',
